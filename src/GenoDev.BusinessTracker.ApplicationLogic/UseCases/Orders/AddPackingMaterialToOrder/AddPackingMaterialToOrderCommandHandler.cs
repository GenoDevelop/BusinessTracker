...
public class AddPackingMaterialToOrderCommandHandler : IRequestHandler<AddPackingMaterialToOrderCommand, Guid>
{
    ...
    public async Task<Guid> Handle(AddPackingMaterialToOrderCommand request, CancellationToken cancellationToken)
    {
        ...
        return orderPackingMaterial.Id;
    }
}
