...
// using Controls = GenoDev.BusinessTracker.Wpf.Infrastructure.Controls;
// using MediatR;
// using System;
...
//
// public partial class RecipesViewModel_old : ViewModelBase
// {
...
//     private Controls.OperatorWrapper? _selectedAmountOperator;
//
...
//
//     public RecipesViewModel_old(IMediator mediator)
//     {
//         _mediator = mediator;
//         _selectedAmountOperator = new Controls.OperatorWrapper(null, "");
...
//     }
//
//     partial void OnSelectedAmountOperatorChanged(Controls.OperatorWrapper? value)
//     {
//         RecipeMaterialsPageIndex = 0;
//         DebounceLoadItems();
//     }
